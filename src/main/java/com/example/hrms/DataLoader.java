...
public class DataLoader implements CommandLineRunner {
    ...
    private void createAttendance(String empCode, String date, String status) {
        AttendanceDynamo att = new AttendanceDynamo(empCode, date);
    ...
    private void createLeave(String empId, LocalDate start, LocalDate end, LeaveType type, String reason) {
        String leaveCode = "LEAVE-" + empId + "-" + start.format(DateTimeFormatter.ISO_LOCAL_DATE);
        LeaveRequestDynamo r = new LeaveRequestDynamo(leaveCode);
        r.setEmployeeCode(empId);
        ...
        System.out.println("Created leave request: " + leaveCode);
    }
